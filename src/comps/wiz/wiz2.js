    ...
    return (
      <div className="compBody">
        ...
        <div className='titlecon'>
          <h1 id='mylistings3' className={this.state.anime ? 'searchTitle2 st22' : 'searchTitle2'}>Step 2</h1>
        </div>
        ...
        <div className='inputsBody'>
            ...
            <div className='inputs'>
            <h2>State</h2>
            <select className='profileInput' value={this.props.stateUSA} onChange={(e) => this.props.updateState(e.target.value)}>
